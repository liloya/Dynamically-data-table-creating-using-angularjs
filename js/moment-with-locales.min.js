...
function ad(a,b){var c={nominative:"იანვა?ი_თებე?ვალი_მა?ტი_აპ?ილი_მაისი_ივნისი_ივლისი_აგვისტო_სექტემბე?ი_ოქტომბე?ი_ნოემბე?ი_დეკემბე?ი".split("_"),accusative:"იანვა?ს_თებე?ვალს_მა?ტს_აპ?ილის_მაისს_ივნისს_ივლისს_აგვისტს_სექტემბე?ს_ოქტომბე?ს_ნოემბე?ს_დეკემბე?ს".split("_")},d=/D[oD] *MMMM?/.test(b)?"accusative":"nominative";return c[d][a.month()]}function bd(a,b){var c={nominative:"კვი?ა_ო?შაბათი_სამშაბათი_ოთხშაბათი_ხუთშაბათი_პა?ასკევი_შაბათი".split("_"),accusative:"კვი?ას_ო?შაბათს_სამშაბათს_ოთხშაბათს_ხუთშაბათს_პა?ასკევს_შაბათს".split("_")},d=/(წინა|შემდეგ)/.test(b)?"accusative":"nominative";return c[d][a.day()]}
//! moment.js locale configuration
